...
export wcontent=$GOPATH/src/github.com/glennswest/winoperatordata
go get ./...
...
(cd ../${wcontent};git add -f wcontent/content/winnodeman.exe;git add -f wcontent/content/winnodeman.version;git commit -a -m "Update winnodeman executable";git push origin master)
