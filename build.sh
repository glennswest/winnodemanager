...
(cd ../${wcontent};git add wcontent/content/winnodeman.exe;git add wcontent/content/winnodeman.version;git commit -f -a -m "Update winnodeman executable";git push origin master)
